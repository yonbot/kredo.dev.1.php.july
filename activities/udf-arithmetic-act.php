    ...
    <div class="container mt-3 w-50">
      ...
      <?php
        if (isset($_POST['btn_submit'])) {
          ...
          $sum = addNumber($first_number, $second_number);
          $difference = subtractNumber($first_number, $second_number);
          $product = multiplyNumber($first_number, $second_number);
          $quotient = divideNumber($first_number, $second_number);
          ...
          <div class="w-100 bg-dark rounded mt-5 p-3 text-white">
            ...
            <hr>
            <div class="row">
              <span class="fs-5">Sum = $sum</span>
              <span class="fs-5">Difference = $difference</span>
              <span class="fs-5">Product = $product</span>
              <span class="fs-5">Quotient = $quotient</span>
            </div>
          </div>
