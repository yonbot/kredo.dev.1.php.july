...
<head>
  ...
  <title>If Else Greater Act</title>
</head>
<body>
      ...
      <?php
        if (isset($_POST['btn_submit'])) {
          ...
          if ($first_number > $second_number) {
            echo "<div class=\"fs-5 float-start\">$first_number</div><div class=\"fs-6 float-end\">$second_number</div>";
          } elseif ($first_number < $second_number) {
            echo "<div class=\"fs-5 float-start\">$second_number</div><div class=\"fs-6 float-end\">$first_number</div>";
          } else {
            echo "<span class=\"fs-5\">They are equal.</span>";
          }
