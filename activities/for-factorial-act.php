        ...
        <div class="card">
          ...
          <div class="card-body fs-5">
            <div class="row text-start fw-bold">
              <div class="col">
                <input type="number" name="number" id="number" class="form-control" placeholder="Start Number" required>
              </div>
            </div>
          ...
          <?php
            if (isset($_POST['btn_submit'])) {
              $num = $_POST['number'];
              $answer = getFactorial($num);

              # Factorial = 階乗
              echo '<div class="card-footer fs-5">';

              echo "The Factorial of $num is: $answer<br>";
